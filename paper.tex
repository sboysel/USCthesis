...
%% Figures %%%
\graphicspath{{../pub-goods/figures}}
\graphicspath{{../formation/figures}}
...
% \subfile{data/data.tex}

% \section{Reduced Form} \label{sec:reduced}
% \subfile{reduced/reduced.tex}

% \section{Structural Model} \label{sec:structural}
% \subfile{struct/struct.tex}
...
% \subfile{appendix/tables/tables.tex}

% \clearpage
% \section{Figures} \label{app:figures}
% \subfile{appendix/figures/figures.tex}

% \clearpage
% \section{Data Details} \label{app:data}
% \subfile{appendix/data/data.tex}

% \clearpage
% \onehalfspacing
% \section{Additional Reduced Form Results} \label{app:reduced-details}
% \subfile{appendix/reduced-details/reduced-details.tex}

% \clearpage
% \onehalfspacing
% \section{Structural Estimation Details} \label{app:estim-details}
% \subfile{appendix/estim/estim.tex}
